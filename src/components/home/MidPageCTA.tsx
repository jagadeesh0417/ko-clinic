...
export function MidPageCTA() {
  return (
    <section className="relative py-24 md:py-32 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-[rgba(201,168,106,0.05)] to-[rgba(8,8,8,0.95)]" />
      ...
      <div className="relative z-10 container-custom px-6 text-center">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="font-heading text-5xl md:text-7xl font-light text-[#FAFAFA] mb-4"
        >
        ...
        <motion.p
          ...
          className="text-[#A1A1AA] text-lg md:text-xl font-body mb-8"
        >
