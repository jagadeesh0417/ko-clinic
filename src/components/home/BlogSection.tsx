        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          {posts.map((post, i) => (
            <GlassCard key={post.slug} delay={i * 0.1}>
              <span className="text-xs font-button uppercase tracking-wider text-[#C9A86A]">
                {post.category}
              </span>
              <h3 className="font-heading text-xl text-[#FAFAFA] mt-2 mb-3 hover:text-gradient-gold transition-all">
