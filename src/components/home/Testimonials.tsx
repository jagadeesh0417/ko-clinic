        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
          {testimonials.map((testimonial, i) => (
            <GlassCard key={i} delay={i * 0.1}>
              <Quote className="w-8 h-8 text-[#C9A86A] mb-4 opacity-50" />
              <p className="text-[#A1A1AA] text-sm leading-relaxed mb-6 font-body italic">
              ...
              <div>
                <p className="text-[#FAFAFA] font-heading text-lg">{testimonial.name}</p>
